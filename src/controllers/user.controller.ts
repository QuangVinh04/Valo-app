...
export class UserController {
  ...
  getUserById = catchAsync(
    async (req: Request, res: Response<ApiResponse<UserResponseDto>>, _next: NextFunction) => {
  ...
  createUser = catchAsync(
    async (req: Request, res: Response<ApiResponse<CreatedUserDto>>, _next: NextFunction) => {
