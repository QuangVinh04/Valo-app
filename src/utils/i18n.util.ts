...
const messages = {
  en: {
    ...
    INVALID_EXPIRED_ACCOUNT_LINK: 'Invalid or expired account link',
    EMAIL_SEND_FAILED: 'Email send failed',
    OTP_RESEND_TOO_SOON: 'OTP resend too soon',
    CANNOT_DELETE_LAST_ADMIN: 'Cannot delete the last admin user',
    GROUP_NOT_FOUND: 'Group not found',
    GROUP_NAME_ALREADY_IN_USE: 'Group name already in use',
    CANNOT_DELETE_SYSTEM_GROUP: 'Cannot delete system group',
  ...
  vi: {
    ...
    INVALID_EXPIRED_ACCOUNT_LINK: 'Liên kết tài khoản không hợp lệ hoặc đã hết hạn',
    EMAIL_SEND_FAILED: 'Gửi email thất bại',
    OTP_RESEND_TOO_SOON: 'Vui lòng đợi trước khi gửi lại OTP',
    CANNOT_DELETE_LAST_ADMIN: 'Không thể xóa người quản trị cuối cùng',
    GROUP_NOT_FOUND: 'Không tìm thấy nhóm',
    GROUP_NAME_ALREADY_IN_USE: 'Tên nhóm đã được sử dụng',
    CANNOT_DELETE_SYSTEM_GROUP: 'Không thể xóa nhóm hệ thống',
